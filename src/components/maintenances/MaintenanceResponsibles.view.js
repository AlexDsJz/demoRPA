                        ...
                        <div class="d-flex" style={{color: "#000"}}>
                          ...
                          : 
                            maintenancePerm.manuallyEnabled ?
                              <div onClick={() => enabledManuallyPerms(maintenancePerm.id, maintenancePerm.category.id)}>
                          ...
                          <div className = "ml-3"
                            ...
                            {maintenancePerm.users.length > 0 ? 
                              <i class="fa fa-check icon-no-css ml-1 mt-1"></i> : null}
                          </div>
                        </div>
                      </a>
                    </li>
...
MaintenanceResponsiblesView.propTypes = {
  ...
  enabledManuallyPerms: PropTypes.func
};
