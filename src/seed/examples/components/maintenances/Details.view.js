  ...
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${maintenance.id}/edit`} class="btn btn-secondary mr-2">Edit maintenance</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete maintenance</button>
      </div>
    </div>
  </div>;
