...
const PartDetailsView = ({ part, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${part.id}/edit`} class="btn btn-secondary mr-2">Edit part</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete part</button>
      </div>
    </div>
  </div>;

PartDetailsView.propTypes = {
  part: PropTypes.object.isRequired,
  onClickDelete: PropTypes.func
};

export default PartDetailsView;