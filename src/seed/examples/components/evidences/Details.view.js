...
const EvidenceDetailsView = ({ evidence, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${evidence.id}/edit`} class="btn btn-secondary mr-2">Edit evidence</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete evidence</button>
      </div>
    </div>
  </div>;

EvidenceDetailsView.propTypes = {
  evidence: PropTypes.object.isRequired,
  onClickDelete: PropTypes.func
};

export default EvidenceDetailsView;