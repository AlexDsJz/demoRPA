...
const AppInfoDetailsView = ({ appInfo, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${appInfo.id}/edit`} class="btn btn-secondary mr-2">Edit app info</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete app info</button>
      </div>
    </div>
  </div>;

AppInfoDetailsView.propTypes = {
  appInfo: PropTypes.object.isRequired,
  onClickDelete: PropTypes.func
};

export default AppInfoDetailsView;