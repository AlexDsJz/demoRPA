...
const SecurityRevisionDetailsView = ({ securityRevision, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${securityRevision.id}/edit`} class="btn btn-secondary mr-2">Edit security revision</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete security revision</button>
      </div>
    </div>
  </div>;

SecurityRevisionDetailsView.propTypes = {
  securityRevision: PropTypes.object.isRequired,
