...
const SuggestionDetailsView = ({ suggestion, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${suggestion.id}/edit`} class="btn btn-secondary mr-2">Edit suggestion</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete suggestion</button>
      </div>
    </div>
  </div>;

SuggestionDetailsView.propTypes = {
