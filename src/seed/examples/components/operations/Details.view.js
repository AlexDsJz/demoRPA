...
const OperationDetailsView = ({ operation, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${operation.id}/edit`} class="btn btn-secondary mr-2">Edit operation</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete operation</button>
      </div>
    </div>
  </div>;
