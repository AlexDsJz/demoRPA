...
const OrderDetailsView = ({ order, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${order.id}/edit`} class="btn btn-secondary mr-2">Edit order</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete order</button>
      </div>
    </div>
  </div>;
