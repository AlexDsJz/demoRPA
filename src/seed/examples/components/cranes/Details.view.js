...
const CraneDetailsView = ({ crane, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${crane.id}/edit`} class="btn btn-secondary mr-2">Edit crane</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete crane</button>
      </div>
    </div>
  </div>;

CraneDetailsView.propTypes = {
  crane: PropTypes.object.isRequired,
  onClickDelete: PropTypes.func
};

export default CraneDetailsView;