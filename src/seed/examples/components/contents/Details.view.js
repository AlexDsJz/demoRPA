...
const ContentDetailsView = ({ content, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${content.id}/edit`} class="btn btn-secondary mr-2">Edit content</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete content</button>
      </div>
    </div>
  </div>;

ContentDetailsView.propTypes = {
